# Mindless (流水账) · Flutter todolist / 待办清单 · 番茄钟 · 数据分析

> **⚠️ 醒目声明**：
> **整个 App 都是 AI 做的，作者没有阅读一丁半点的代码，开源协议是瞎选的。**

Mindless 是一款基于 Flutter 开发的极简主义 **todolist / 待办清单** 与专注工具。它结合了任务管理、番茄钟专注以及深度的心理与效率分析，旨在帮助用户在快节奏的生活中找回专注力，并建立良好的习惯反馈循环。
