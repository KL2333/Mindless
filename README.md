...
| 1. 起点 (Main) | 2. 场域 (Quadrants) | 3. 星图 (Stats) |
| :---: | :---: | :---: |
| ![起点](screenshots/1.jpg) | ![场域](screenshots/2.jpg) | ![星图](screenshots/3.jpg) |
| **实时黑洞视觉仪表盘**<br>追踪今日专注时长与可用时间，<br>按早中晚时段科学排程。 | **引力四象限场域**<br>独特的任务优先级管理视图，<br>根据“能量”与“轨道”智能分区。 | **全维度数据星图**<br>深度分析活力趋势、标签分布，<br>让你的进步清晰可见。 |

| 4. 曲率 (Pomodoro) | 5. 智算 (Smart Plan) |
| :---: | :---: |
| ![曲率](screenshots/4.jpg) | ![智算](screenshots/5.jpg) |
| **沉浸式曲率计时器**<br>视觉化时间扭曲效果，<br>实时监测“心流指数”与专注质量。 | **智算分析报告**<br>全量汇总任务、统计与心理洞察，<br>提供针对性的效率改进建议。 |
